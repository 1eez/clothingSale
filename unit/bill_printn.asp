...
set rs = server.createobject("adodb.recordset")
	sql = "select * from t_depotdetail where billcode='"&billcode&"'"
...
<span style=width:180px;><label class="10 b">手工单号：</label><label class="10"><%=oldbill%></label></span>
...
<%
	...
	%>
		<tr style=border:0px;><td colspan=3 style=border:0px;><label class="10 b"></span></label>
		<td align=right style=border:0px;><label class="10 b">合计：</label></td><td style=border:0px; colspan=2><label class="10"><%=tnumber%></label></tr>
		</table>
		</div>
		&nbsp;&nbsp;<span style=width:170px;><label class="10 b">经办人：</label><label class="10"><%=f_user%></label></span>
		<span style=width:220px;><label class="10 b">保管员：</label><label class="10" style="text-decoration:underline">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></span>
